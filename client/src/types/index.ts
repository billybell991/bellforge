...
export const BUILD_STAGES: BuildStage[] = [
  ...
  { id: 'gradle_setup', name: 'Assembling Android Project', percent: 78, icon: '📦' },
  { id: 'gradle_build', name: 'Building APK with Gradle', percent: 90, icon: '🔨' },
  { id: 'signing', name: 'Signing APK', percent: 95, icon: '🔐' },
